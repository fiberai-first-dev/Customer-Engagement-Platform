...
function statusClass(status: string): string {
  ...
  if (value.includes("deliver")) return "bg-emerald-500/10 text-emerald-700 border-emerald-500/20";
  if (value.includes("ship") || value.includes("out for")) return "bg-blue-500/10 text-blue-700 border-blue-500/20";
  if (value.includes("cancel") || value.includes("return")) return "bg-red-500/10 text-red-700 border-red-500/20";
  if (value.includes("place") || value.includes("confirm")) return "bg-amber-500/10 text-amber-700 border-amber-500/20";
